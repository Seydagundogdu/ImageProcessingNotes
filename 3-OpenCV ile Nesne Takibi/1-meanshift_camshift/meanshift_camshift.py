# -*- coding: utf-8 -*-
"""
Created on Fri Mar 11 13:50:14 2022
...
# bir tane frame oku
# frame okuma işlemi while döngüsü içerisinde yapılırsa bu takip değil tespit algoritması olur
ret, frame = cap.read()

if ret == False: # eğer yüzü göremezse
    print("Uyarı")
